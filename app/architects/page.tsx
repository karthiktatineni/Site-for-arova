...
const architects = [
  {
    ...
    role: "Lead Architect",
    specialty: "Luxury Residential & Brutalist Fusion",
    experience: "15 Years+",
  ...
  },
  {
    ...
    specialty: "Tactile Minimalism & Material Curation",
    experience: "12 Years+",
      ...
      <section className="px-6 md:px-margin-page">
        <div className="max-w-[800px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-8">
          {architects.map((architect, i) => (
            ...
            >
              <Link href={`/architects/${architect.id}`} className="block overflow-hidden rounded-lg bg-white shadow-sm border border-outline-variant/10 hover:shadow-md transition-all duration-500">
